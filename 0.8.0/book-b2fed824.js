...
(function codeSnippets() {
    function run_nadi_code(code_block) {
        var result_block = code_block.querySelector(".result");
        if (!result_block) {
            result_block = document.createElement('code');
            result_block.className = 'result hljs language-output';

            code_block.append(result_block);
        }

        const text = playground_text(code_block);
	run_nadi(text, result_block);
    }
    ...
    Array.from(document.querySelectorAll("code.language-task")).forEach(function (
	editable_code,
    ) {
    ...
    if (window.ace) {
        ...
        code_nodes
            ...
            .forEach(function(block) {
                block.classList.remove('language-task');
                block.classList.remove('language-task');
            });
    ...
    Array.from(document.querySelectorAll('code.language-task')).forEach(function(block) {
